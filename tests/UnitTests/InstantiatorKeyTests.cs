...
namespace HotAssembly.Tests
{
    public class InstantiatorKeyTests : IDisposable
    {
        ...
        {
            Exception ex = Assert.Throws<InstantiatorException>(() => new InstantiatorKey(packageId, version, fullTypeName));
        ...
        public void Success_NotEqual(string packageId1, string version1, string fullTypeName1, string packageId2, string version2, string fullTypeName2)
        {
        ...
        [InlineData("SomePackageName", "1.0-pre", "Some.Type", "SomePackageName", "1.1-pre", "Some.Type")]
        [InlineData("SomePackageName", "1.0.1", "Some.Type", "SomePackageName", "1.0.1", "Some.Type1")]
        public void Success_NotEqualToString(string packageId1, string version1, string fullTypeName1, string packageId2, string version2, string fullTypeName2)
        {
            var key1 = new InstantiatorKey(packageId1, version1, fullTypeName1);
            var key2 = new InstantiatorKey(packageId2, version2, fullTypeName2);
