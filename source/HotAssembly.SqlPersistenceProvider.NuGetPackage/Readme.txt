...
In order to use it, you should perform the following steps:

1. Create new connection string in your app or web config file. The connection string name should be "HotAssembly".For example:
<add name="<your databasae name>" connectionString="Data Source=db-01;Initial Catalog=HotAssembly;Integrated Security=True;Asynchronous Processing=True" />


2. Create database. You should make sure that your SQL server allows FILESTREAM data.
USE [master]
GO
-- you can change the name to anything.
